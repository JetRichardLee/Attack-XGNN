...
#
###################################
def gen_syn1(nb_shapes=160, width_basis=2000, feature_generator=None, m=5):
    """ Synthetic Graph #1:
...
def gen_syn2(nb_shapes=100, width_basis=2500):
    """ Synthetic Graph #2:
...
def gen_syn4(nb_shapes=10, width_basis=20, feature_generator=None, m=4):
    """ Synthetic Graph #4:
