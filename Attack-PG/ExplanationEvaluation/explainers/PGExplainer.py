...
class PGExplainer(BaseExplainer):
    ...
    """
    def __init__(self, model_to_explain, graphs, features, task, epochs=50, lr=0.003, temp=(5.0, 2.0), reg_coefs=(0.05, 1.0),sample_bias=0):
    ...
    def train(self, indices = None):
        ...
        for e in tqdm(range(0, self.epochs)):
            ...
            for n in indices:
                ...
                if self.type == 'node' or self.type == 'ogb_node': # we only care for the prediction of the node
